...
- 내부 순서:
  ...
  - `debugLog/debugLogFlow.ts` 유틸로 패널 액션 로그 누적 렌더/복사 버튼 동작(`Debug Log` 패널 title의 `⧉`) 위임
...
- `panel.html`
  ...
  - Selected Element / DOM Path / Selected DOM Tree / Raw Result / Debug Log의 스크롤/배경/최소높이 제어
