...
- 파일: `src/features/panel/controller.ts`, `src/features/panel/controller/wiring/controllerWiring.ts`, `src/features/panel/controller/wiring/controllerWiringDebug.ts`, `src/features/panel/controller/wiring/controllerWiringDataFlows.ts`, `src/features/panel/controller/wiring/controllerWiringReactInspector.ts`, `src/features/panel/controller/wiring/controllerWiringLifecycle.ts`, `src/features/panel/controller/wiring/controllerWiringLifecycleRefresh.ts`, `src/features/panel/controller/wiring/controllerWiringPane.ts`, `src/features/panel/controller/bootstrap.ts`, `src/features/panel/controller/bootstrapBindings.ts`, `src/features/panel/controller/context.ts`, `src/features/panel/controller/runtime.ts`, `src/features/panel/controller/runtimePickerFlow.ts`, `src/features/panel/devtoolsNetworkBridge.ts`, `src/features/panel/domRefs.ts`, `src/features/panel/bridge/**`, `src/features/panel/domTree/**`, `src/features/panel/pageAgent/**`, `src/features/panel/reactInspector/**`, `src/features/panel/runtimeRefresh/**`, `src/features/panel/workspace/**`, `src/ui/sections/shell/PanelViewSection.tsx`, `src/ui/sections/**`, `src/ui/panels/**`, `src/ui/components/**`
...
- 역할: 요소 선택 오버레이/하이라이트 상태(선택 중 pointer/click/contextmenu/Escape/Enter 이벤트 consume 포함), runtime hook/pageAgent 브리지 상태, 선택 element selector/path 정보 계산(중복 id 감지 시 ancestor 범위 selector로 보정), runtime 메시지 안전 전송 유틸

4. Main world scripts (페이지 컨텍스트)
- 파일: `src/content/pageAgent.ts`, `src/content/runtime/pageAgentRuntime.ts`, `src/content/runtime/pageAgentRuntimeBootstrap.ts`, `src/content/runtime/pageAgentRuntimeConfig.ts`, `src/content/runtime/pageAgentRuntimeDomHandlers.ts`, `src/content/runtime/pageAgentRuntimeMethodHandlers.ts`, `src/content/runtime/pageAgentRuntimeInspectHandlers.ts`, `src/content/runtime/pageAgentRuntimeInstallFlow.ts`, `src/content/runtime/pageAgentRuntimeTypes.ts`, `src/content/dom/pageAgentDom.ts`, `src/content/dom/pageAgentDomSelectors.ts`, `src/content/dom/pageAgentDomTree.ts`, `src/content/dom/pageAgentDomHighlight.ts`, `src/content/dom/pageAgentDomHighlightState.ts`, `src/content/pageAgentBridge.ts`, `src/content/pageAgentBridgeMessages.ts`, `src/content/pageAgentMethods.ts`, `src/content/pageAgentTargetFetch.ts`, `src/content/hooks/pageAgentHookGroups.ts`, `src/content/hooks/pageAgentHookGroupRuntimeContext.ts`, `src/content/hooks/pageAgentHookStack.ts`, `src/content/hooks/pageAgentHookGrouping.ts`, `src/content/hooks/pageAgentHookGroupingAncestor.ts`, `src/content/hooks/pageAgentHookGroupingPath.ts`, `src/content/hooks/pageAgentHookGroupingPrimitive.ts`, `src/content/hooks/pageAgentHookRuntime.ts`, `src/content/hooks/pageAgentHookResult.ts`, `src/content/hooks/pageAgentHookMetadataBuild.ts`, `src/content/hooks/inspect/pageAgentHookPrimitiveStack.ts`, `src/content/hooks/inspect/pageAgentHookInspectContext.ts`, `src/content/hooks/inspect/pageAgentHookInspectRender.ts`, `src/content/hooks/inspect/pageAgentHookRenderExecution.ts`, `src/content/hooks/inspect/pageAgentHookDispatcher.ts`, `src/content/hooks/inspect/pageAgentHookDispatcherTypes.ts`, `src/content/hooks/inspect/pageAgentHookDispatcherState.ts`, `src/content/hooks/inspect/pageAgentHookDispatcherMethodTypes.ts`, `src/content/hooks/inspect/pageAgentHookDispatcherMethodContextState.ts`, `src/content/hooks/inspect/pageAgentHookDispatcherMethodEffects.ts`, `src/content/hooks/inspect/pageAgentHookDispatcherMethodComputed.ts`, `src/content/hooks/inspect/pageAgentHookDispatcherMethods.ts`, `src/content/hooks/pageAgentHookState.ts`, `src/content/hooks/pageAgentHookMetadata.ts`, `src/content/hooks/pageAgentHooksInfo.ts`, `src/content/pageAgentInspect.ts`, `src/content/pageAgentInspectTypes.ts`, `src/content/pageAgentInspectFlowWiring.ts`, `src/content/pageAgentInspectSelection.ts`, `src/content/inspect/path/pageAgentInspectPathArgs.ts`, `src/content/inspect/path/pageAgentInspectPathValue.ts`, `src/content/inspect/path/pageAgentInspectPathMode.ts`, `src/content/inspect/path/pageAgentInspectPathFlow.ts`, `src/content/inspect/components/pageAgentInspectComponentsArgs.ts`, `src/content/inspect/components/pageAgentInspectComponentsSource.ts`, `src/content/inspect/components/pageAgentInspectComponentsDomFallback.ts`, `src/content/inspect/components/pageAgentInspectComponentsRoot.ts`, `src/content/inspect/components/pageAgentInspectComponentsWalkContext.ts`, `src/content/inspect/components/pageAgentInspectComponentsResult.ts`, `src/content/inspect/components/pageAgentInspectComponentsFlow.ts`, `src/content/pageAgentInspectDomInfo.ts`, `src/content/pageAgentInspectTarget.ts`, `src/content/pageAgentInspectComponentWalk.ts`, `src/content/fiber/pageAgentFiberSearch.ts`, `src/content/fiber/pageAgentFiberSearchTypes.ts`, `src/content/fiber/pageAgentFiberSearchTree.ts`, `src/content/fiber/pageAgentFiberSearchDomScan.ts`, `src/content/fiber/pageAgentFiberElement.ts`, `src/content/fiber/pageAgentFiberDescribe.ts`, `src/content/fiber/pageAgentFiberRegistry.ts`, `src/content/serialization/pageAgentSerialization.ts`, `src/content/serialization/pageAgentSerializationValue.ts`, `src/content/serialization/pageAgentSerializationValuePrimitives.ts`, `src/content/serialization/pageAgentSerializationProps.ts`, `src/content/serialization/pageAgentSerializationPropsBudget.ts`, `src/content/serialization/pageAgentSerializationPropsEntries.ts`, `src/content/serialization/pageAgentSerializationCore.ts`, `src/content/serialization/pageAgentSerializationCoreInternalKey.ts`, `src/content/serialization/pageAgentSerializationCoreDehydrated.ts`, `src/content/serialization/pageAgentSerializationCoreSeenStore.ts`, `src/content/serialization/pageAgentSerializationStrategies.ts`, `src/content/serialization/pageAgentSerializationStrategyTypes.ts`, `src/content/serialization/pageAgentSerializationCollectionStrategies.ts`, `src/content/serialization/pageAgentSerializationObjectStrategy.ts`, `src/content/serialization/pageAgentCollectionPath.ts`, `src/content/serialization/pageAgentSerializerSummary.ts`, `src/content/serialization/pageAgentSerializerOptions.ts`, `src/content/reactRuntimeHook.ts`, `src/content/reactRuntimeHookLifecycle.ts`
...
- 내부 순서:
  ...
  - `pageAgent/selectionSync.ts` 유틸로 선택 컴포넌트 DOM 하이라이트/Selected Element·DOM Tree 동기화(중복 selector 시 domPath 보조 매칭 + highlight request epoch 기반 stale 응답 차단) 위임
  ...
  - `controller/runtime.ts`, `controller/runtimePickerFlow.ts` 유틸로 runtime refresh + picker bridge/runtime listener + panel keydown shortcut relay 결선 + teardown 결선 책임 위임
  - `controller/bootstrap.ts`, `controller/bootstrapBindings.ts` 유틸로 workspace 초기화 결선 + bootstrap flow 결선 책임 위임
...
- `controllerWiringPane.ts`는 pane setter/pane debug 래퍼/pageAgent debug caller 결선을 조립해 `controllerWiring.ts`의 상태 UI 결선 책임을 축소한다.
- `controller/runtimePickerFlow.ts`는 element picker bridge + runtime message listener 결선(스케줄러 schedule/reset 위임 포함)과 패널 keydown(Enter/Escape) shortcut relay 결선을 조립해 `controller/runtime.ts`의 책임을 축소한다.
...
2. content가 오버레이 생성 및 hover/click/focus 추적
  ...
  - panel이 picker 활성화 직후 `syncElementPickerPreview` 제어 메시지로 현재 하이라이트/포커스 target preview를 한 번 더 요청해, picker 시작 직전/직후에 도착한 초기 preview가 panel 활성화 race로 유실되지 않게 한다.
...
실제 브리지/메서드 라우터/도메인 핸들러 조립은 `src/content/runtime/pageAgentRuntime.ts`가 담당합니다.
React inspect/inspectPath 오케스트레이션은 `src/content/pageAgentInspect.ts`로 위임합니다.
componentId 기반 root/fiber 탐색은 `src/content/fiber/pageAgentFiberSearch.ts`로 위임합니다.
DOM element에서 React fiber 추적(`__reactFiber$`, `__reactContainer$`) 유틸은 `src/content/fiber/pageAgentFiberElement.ts`로 위임합니다.
fiber name/tag/선택 대상 계산 유틸은 `src/content/fiber/pageAgentFiberDescribe.ts`로 위임합니다.
fiber stable id map/function inspect registry 관리는 `src/content/fiber/pageAgentFiberRegistry.ts`로 위임합니다.
...
hook 이름 추론/Ref 상태 정규화는 `src/content/hooks/pageAgentHookState.ts`로 위임합니다.
custom hook metadata 병합은 `src/content/hooks/pageAgentHookMetadata.ts`로 위임합니다.
fiber hook linked-list 정규화/개수 집계/직렬화 payload 구성은 `src/content/hooks/pageAgentHooksInfo.ts`로 위임합니다.
DOM selector/path 계산은 `src/content/dom/pageAgentDom.ts`로, DOM tree 직렬화(selector+pickPoint+domPath 보조 해석)는 `src/content/dom/pageAgentDomTree.ts`로, highlight/preview 상태 복원·적용(selector+domPath 후보 매칭 포함)은 `src/content/dom/pageAgentDomHighlight.ts`로 위임합니다.
...
custom hook stack 파싱 유틸은 `src/content/hooks/pageAgentHookStack.ts`로, group path 추론 유틸은 `src/content/hooks/pageAgentHookGrouping.ts`로, dispatcher/ref/render 대상 해석 유틸은 `src/content/hooks/pageAgentHookRuntime.ts`로, hook dispatcher 타입/상태/메서드 구성 유틸은 `src/content/hooks/inspect/pageAgentHookDispatcherTypes.ts`/`src/content/hooks/inspect/pageAgentHookDispatcherState.ts`/`src/content/hooks/inspect/pageAgentHookDispatcherMethods.ts`로, dispatcher 조립/Proxy fallback 유틸은 `src/content/hooks/inspect/pageAgentHookDispatcher.ts`로, inspect dispatcher/state+warmup cache 조립 유틸은 `src/content/hooks/inspect/pageAgentHookInspectContext.ts`로, render pass 조립 유틸은 `src/content/hooks/inspect/pageAgentHookInspectRender.ts`로, dispatcher 교체/console mute/render 실행 유틸은 `src/content/hooks/inspect/pageAgentHookRenderExecution.ts`로, 전체 오케스트레이션은 `src/content/hooks/pageAgentHookGroups.ts`로 위임합니다.

새 메서드 추가 시:

1. 도메인에 맞는 모듈(`runtime/pageAgentRuntime.ts`, `pageAgentDom.ts`, `pageAgentDomTree.ts`, `pageAgentDomHighlight.ts`, `pageAgentInspect.ts`, `pageAgentFiberSearch.ts`, `pageAgentFiberElement.ts`, `pageAgentFiberDescribe.ts`, `pageAgentFiberRegistry.ts`, `pageAgentSerialization.ts`, `pageAgentSerializationCore.ts`, `pageAgentCollectionPath.ts`, `pageAgentSerializerSummary.ts`, `pageAgentSerializerOptions.ts`, `pageAgentHookState.ts`, `pageAgentHookMetadata.ts`, `pageAgentHooksInfo.ts`)에 구현 함수 추가
...
- `runtime/pageAgentRuntime.ts`: main-world 진입용 runtime 설치 facade 전담
...
- `runtime/pageAgentRuntime.ts`: main-world runtime 설치 facade(install flow 위임) 전담
...
- `runtime/pageAgentRuntimeBootstrap.ts`: dom handler + inspect handler를 method executor로 조합하는 bootstrap 오케스트레이션 전담
...
- `runtime/pageAgentRuntimeBootstrap.ts`: React inspect/domain 핸들러 구현체를 라우터에 주입하는 조립 전담
- `runtime/pageAgentRuntimeInspectHandlers.ts`: inspect 의존성 결선을 `runtime/pageAgentRuntimeBootstrap.ts` 밖으로 분리해 라우터 조립 책임을 축소
...
- `pageAgentInspectComponentsDomFallback.ts`: non-React target element를 `DomElement` fallback component(leaf/ancestor chain)로 변환하는 스키마/직렬화 전담
...
- `pageAgentInspectComponentsFlow.ts`: `reactInspect` root helper + walk helper + result helper를 조합하고, React fiber 미탐색/DOM 매칭 불일치 시 `DomElement` fallback을 응답 payload로 합성하는 오케스트레이션 전담
...
- `runtime/pageAgentRuntime.ts`: runtime 설치 facade와 호출 진입점 전담
...
- `runtime/pageAgentRuntimeBootstrap.ts`: method executor 생성 오케스트레이션 전담

## 6.6 pageAgent Fiber Search 모듈 분리 규칙

- `fiber/pageAgentFiberSearch.ts`: componentId 기반 root/fiber 탐색 오케스트레이션 전담(`findRootFiberByComponentId`, `findFiberByComponentId*`)
- `fiber/pageAgentFiberSearchTypes.ts`: fiber search helper 타입(`FiberLike`, options) 정의 전담
- `fiber/pageAgentFiberSearchTree.ts`: root subtree DFS 기반 component id 존재 검사/target fiber 탐색 전담
- `fiber/pageAgentFiberSearchDomScan.ts`: document BFS 기반 root fiber 스캔(visited-root dedupe 포함) 전담
- 2026-02 리팩터링: fiber search 모듈(`types/tree/domScan/main`)에서 `@ts-nocheck`를 제거하고 `tag` type guard를 도입해 inspectable 판정 타입 안정성을 강화
- `fiber/pageAgentFiberElement.ts`: DOM element -> fiber 탐색(`getReactFiberFromElement`, `findNearestFiber`, `findAnyFiberInDocument`) 전담
- `fiber/pageAgentFiberDescribe.ts`: fiber root/name/tag/선택 대상 계산(`findRootFiber`, `getFiberName`, `isInspectableTag`, `findPreferredSelectedFiber`) 전담
- `fiber/pageAgentFiberRegistry.ts`: fiber stable id 할당(`getFiberIdMap`, `getStableFiberId`)과 function inspect registry(`registerFunctionForInspect`) 전담
...
- `runtime/pageAgentRuntimeBootstrap.ts`/`pageAgentInspect.ts`: serializer/collection path 유틸을 호출해 hook/props 데이터 직렬화와 path 탐색 흐름만 조립
...
- 2026-02 리팩터링: main-world pageAgent 경로의 잔여 `@ts-nocheck` 제거 완료(`pageAgentBridge.ts`, `runtime/pageAgentRuntime.ts`, `pageAgentInspectPathFlow.ts`, `pageAgentHookState.ts`, `pageAgentHookInspectContext.ts`, `pageAgentHookInspectRender.ts`, `pageAgentHookMetadata.ts`)
...
- `controller/runtimePickerFlow.ts`: element picker 브리지 + runtime message listener 결선, panel keydown(Enter/Escape) shortcut relay, runtime refresh schedule/reset 연결 전담
...
- `reactInspector/flow/applyFlow.ts`: apply 옵션 정규화, preserveCollapsed 기준 접힘 상태 복원/초기화, 상태 문구·후속 렌더 액션 결정 전담
...
- `reactInspector/flow/controllerFlowTypes.ts`: controller flow 결선 옵션/공용 pane setter 타입 정의 전담
- `reactInspector/flow/controllerFlowInteractionWiring.ts`: list/detail render flow, selection/search binding, detail queue와 no-result 상태 결선 전담
- `reactInspector/flow/controllerFlows.ts`: interaction wiring + fetch/reset/apply 파이프라인 조립 전담(DOM ref getter 기반 지연 접근 + derivation helper 조합)
...
- `controller/runtime.ts`: runtime refresh + teardown 결선을 조합해 controller에서 런타임 이벤트 결선 책임 분리
- `controller/runtimePickerFlow.ts`: element picker + runtime message listener 결선, panel keydown shortcut relay, runtime refresh schedule/reset 연결 책임 분리
- `controller/bootstrap.ts`: workspace initialization + bootstrap flow 결선 호출 순서를 조합해 controller에서 부트스트랩 wiring 책임 분리
- `controller/bootstrapBindings.ts`: workspace initialization/ bootstrap flow 입력 매핑(getter/handler/callback)을 분리해 bootstrap 결선 함수 길이 축소
...
- `controllerWiring.ts`: panel 이벤트/도메인 결선을 조립하고, DOM/lifecycle mutable 상태는 `controller/context.ts`, 런타임 이벤트 결선은 `controller/runtime.ts`, 부트스트랩 결선은 `controller/bootstrap.ts`, React Inspector 상태는 `reactInspector/controllerState.ts`/`reactInspector/controllerStateModel.ts`, 결선 파이프라인은 `reactInspector/flow/controllerFlows.ts`로 위임
...
- `controllerWiringReactInspector.ts`: `reactInspector/path/pathBindings.ts`와 `reactInspector/flow/controllerFlows.ts`를 연결해 `fetchReactInfo`/`onComponentSearchInput` 핸들을 조립
...
- `controllerWiringPane.ts`: panel context/inspector state로 pane setter를 조립하고 debug caller/wrapper를 결선해 wiring 간 공통 바인딩을 제공
...
- `domTree/fetchFlow.ts`: getDomTree 조회 시작 상태, pageAgent 응답 파이프라인 연결, latest-request-only 응답 반영(stale discard), selector 중복 보정용 domPath 전달, 결과 렌더/실패 문구 반영 규칙 전담(`getDomTreeOutputEl` getter 기반 지연 DOM 접근)
...
- `pageAgent/selectionSync.ts`: 선택 컴포넌트 DOM 하이라이트/hover preview 정리 시 selector+domPath를 함께 전달하고, highlight 결과 domPath로 Selected Element/DOM Tree 동기화를 유지하는 계층 전담
...
- `controller/runtimePickerFlow.ts`: picker 상태 setter, DOM/React fetch 액션, runtime refresh scheduler를 주입하고 runtime listener 결선까지 조립
...
- `controller/runtime.ts`: runtime refresh/teardown flow 결선을 구성하고, controller에 onSelect/onUnload 핸들을 제공
- `controller/runtimePickerFlow.ts`: runtime message binding + picker bridge 결선을 구성해 onSelect 핸들과 listener 제거 핸들 저장을 조립
- `controller/bootstrap.ts`: workspace initialization + bootstrap flow를 결선하고 controller에 `bootstrapPanel` 핸들을 제공
- `controller/bootstrapBindings.ts`: panel context getter/setter와 handler를 lifecycle 입력 객체로 정규화해 결선 모듈 간 인터페이스를 안정화
...
- `panel.html`
  ...
  - Selected Element / DOM Path / Selected DOM Tree / Raw Result / Debug Log 스크롤/배경/최소높이 제어
...
- `src/features/panel/controller/wiring/controllerWiringPane.ts`
  - pane setter/pageAgent debug caller/pane debug wrapper 결선 조립 전담
...
1. 도메인 성격에 맞는 모듈(`runtime/pageAgentRuntime.ts`, `pageAgentDom.ts`, `pageAgentDomTree.ts`, `pageAgentDomHighlight.ts`, `pageAgentInspect.ts`, `pageAgentFiberSearch.ts`, `pageAgentFiberElement.ts`, `pageAgentFiberDescribe.ts`, `pageAgentFiberRegistry.ts`, `pageAgentSerialization.ts`, `pageAgentSerializationCore.ts`, `pageAgentCollectionPath.ts`, `pageAgentSerializerSummary.ts`, `pageAgentSerializerOptions.ts`, `pageAgentHookState.ts`, `pageAgentHookMetadata.ts`, `pageAgentHooksInfo.ts`)에 함수 작성
...
- `src/features/panel/controller/bootstrapBindings.ts`
...
- `src/features/panel/reactInspector/flow/applyFlow.ts`
...
- `src/features/panel/reactInspector/flow/controllerFlowTypes.ts`
- `src/features/panel/reactInspector/flow/controllerFlowInteractionWiring.ts`
- `src/features/panel/reactInspector/flow/controllerFlows.ts`
...
- `src/content/runtime/pageAgentRuntime.ts`
- `src/content/runtime/pageAgentRuntimeBootstrap.ts`
...
- `src/content/hooks/pageAgentHookGroups.ts`
- `src/content/hooks/pageAgentHookGroupRuntimeContext.ts`
- `src/content/hooks/pageAgentHookStack.ts`
- `src/content/hooks/pageAgentHookGrouping.ts`
- `src/content/hooks/pageAgentHookRuntime.ts`
- `src/content/hooks/pageAgentHookResult.ts`
- `src/content/hooks/pageAgentHookMetadataBuild.ts`
...
- `src/content/hooks/pageAgentHookState.ts`
- `src/content/hooks/pageAgentHookMetadata.ts`
- `src/content/hooks/pageAgentHooksInfo.ts`
...
- `src/content/inspect/components/pageAgentInspectComponentsDomFallback.ts`
...
- `src/content/fiber/pageAgentFiberSearch.ts`
- `src/content/fiber/pageAgentFiberElement.ts`
- `src/content/fiber/pageAgentFiberDescribe.ts`
- `src/content/fiber/pageAgentFiberRegistry.ts`
...
- 현재 커버하는 리팩터링 축
  ...
  - `tests/panel/controllerWiringPane.test.ts`: `controllerWiringPane.ts`의 pane setter/debug caller/wrapper 결선 조립 분기
  - `tests/panel/runtimePickerFlow.test.ts`: `controller/runtimePickerFlow.ts`의 picker bridge/runtime listener 결선, panel keydown shortcut relay, scheduler schedule/reset 로그 분기
  - `tests/panel/controllerBootstrapBindings.test.ts`: `bootstrapBindings.ts`의 workspace/bootstrap 입력 매핑(getter/setter/handler/callback) 정규화 분기
  ...
  - `tests/reactInspector/fetchOptions.test.ts`: `fetchOptions.ts`의 element selection/runtime refresh preset 기본값(하이라이트/스크롤 플래그) 분기
  ...
  - `tests/content/pageAgentDomTree.test.ts`: `pageAgentDomTree.ts`의 unknown payload 안전 처리, 대상 미발견 에러 처리, DOM tree 직렬화 기본 경로, duplicate selector domPath 보정 분기
  - `tests/content/pageAgentDomSelectors.test.ts`: DOM path/css selector 생성과 selector fallback target resolve 분기
  - `tests/content/elementPickerOverlay.test.ts`: element picker overlay의 pointer/mouse/contextmenu/Escape/Enter 이벤트 consume과 선택/취소 상태 전환 분기
  - `tests/content/pageAgentDomHighlight.test.ts`: `pageAgentDomHighlight.ts`의 highlight/preview 스타일 적용, duplicate selector domPath 매칭, clear 복원, selector 미발견 에러 처리
  ...
  - `tests/content/pageAgentInspectComponentsFlow.test.ts`: `reactInspect` 입력 파싱/nearest source summary/기본 selectedIndex/nearest 미해석 에러 + non-React DOM fallback(chain/leaf) 분기
