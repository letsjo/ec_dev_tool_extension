...
- `reactInspector/controllerFlows.ts`: controller의 React Inspector 결선(검색/선택/상세/fetch/apply/reset 파이프라인 조립) 전담(DOM ref getter 기반 지연 접근 + derivation helper 조합)
