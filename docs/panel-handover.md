...
- `reactInspector/jsonPreviewPrimitive.ts`: JSON/hook preview의 primitive/dehydrated 문자열 포맷 규칙 전담
- `reactInspector/jsonPreviewObjectMeta.ts`: object class meta key 판별/표시 이름 계산(`isJsonInternalMetaKey`, `getObjectDisplayName`) 전담
- `reactInspector/jsonPreviewTokenStrategies.ts`: summary/hook inline preview의 function/circular/dehydrated token 분기 전담
- `reactInspector/jsonPreviewBudget.ts`: preview budget 생성/소비/소진 판별 공통 유틸 전담
- `reactInspector/jsonPreview.ts`: JSON/hook inline summary preview 오케스트레이션(primitive/token/object/array/collection 전략 결선) 전담
...
- `src/features/panel/reactInspector/jsonPreviewPrimitive.ts`
- `src/features/panel/reactInspector/jsonPreviewObjectMeta.ts`
- `src/features/panel/reactInspector/jsonPreviewTokenStrategies.ts`
- `src/features/panel/reactInspector/jsonPreviewBudget.ts`
...
- `src/content/pageAgentInspectPathArgs.ts`
...
- `src/content/pageAgentInspectComponentsRoot.ts`
- `src/content/pageAgentInspectComponentsWalkContext.ts`
- `src/content/pageAgentInspectComponentsResult.ts`
